...
@Configuration
@ComponentScan(basePackages = { "com.Mybatics.Service" })
public class StudentConfig {
    ...
    // scan tất cả những mapper package com.Mybatics.Mapper
    @Bean
    public MapperScannerConfigurer mapperScannerConfigurer() {
        MapperScannerConfigurer mapperScannerConfigurer = new MapperScannerConfigurer();
        mapperScannerConfigurer.setBasePackage("com.Mybatics.Mapper");
