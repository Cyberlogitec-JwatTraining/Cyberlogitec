...
@Configuration
@ComponentScan(basePackages = { "vn.com.cyberlogitec.service" })
public class AppConfig {
    ...
    // scan tất cả những mapper package vn.com.cyberlogitec
    @Bean
    public MapperScannerConfigurer mapperScannerConfigurer() {
        MapperScannerConfigurer mapperScannerConfigurer = new MapperScannerConfigurer();
        mapperScannerConfigurer.setBasePackage("vn.com.cyberlogitec.mapper");
