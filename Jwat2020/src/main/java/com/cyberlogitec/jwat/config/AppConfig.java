package com.cyberlogitec.jwat.config;
...
@Configuration
@ComponentScan(basePackages = { "com.cyberlogitec.jwat.service" })
public class AppConfig {
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.cyberlogitec.jwat.mapper");
