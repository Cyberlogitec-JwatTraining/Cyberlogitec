package vn.com.cyberlogitec.practice_03.XMLMapper;
...
import vn.com.cyberlogitec.practice_03.XMLMapper.mapper.EmployeeMapper;
...
public class MainTest {
	...
	public static void main(String[] args) {
		Reader reader;
		try {
			reader = Resources.getResourceAsReader("SqlMapXMLConfig.xml");
