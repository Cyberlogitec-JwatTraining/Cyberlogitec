...
@Configuration
@ComponentScan(basePackages = "vn.com.cyberlogitec.jwat.service")
public class AppConfig {
	...
	public SqlSessionFactoryBean sqlSessionFactory() throws Exception {
		...
		sqlSessionFactory.setConfigLocation((org.springframework.core.io.Resource) resource);
	...
	public MapperScannerConfigurer mapperScannerConfigurer() {
		...
		mapperScannerConfigurer.setBasePackage("vn.com.cyberlogitec.jwat.mapper");
	...
	// vn.viettuts.mapper
	/*
	 * @Bean (name = "studentMapper") public StudentMapper studentMapper() throws
	 * Exception { SqlSessionTemplate sessionTemplate = new
